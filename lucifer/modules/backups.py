...
from lucifer import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from lucifer.__main__ import DATA_IMPORT
...
from lucifer.modules.rules import get_rules
import lucifer.modules.sql.rules_sql as rulessql
from lucifer.modules.sql import warns_sql as warnssql
import lucifer.modules.sql.blacklist_sql as blacklistsql
from lucifer.modules.sql import disable_sql as disabledsql
from lucifer.modules.sql import cust_filters_sql as filtersql
import lucifer.modules.sql.welcome_sql as welcsql
import lucifer.modules.sql.locks_sql as locksql
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("lucifer{}.backup".format(chat_id), "w")
