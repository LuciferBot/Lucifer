...
if ENV:
    ...
    from lucifer.config import Development as Config
...
from lucifer.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
